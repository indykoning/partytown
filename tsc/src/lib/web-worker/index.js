...
const receiveMessageFromSandboxToWorker = (ev) => {
    ...
    if (webWorkerCtx.$isInitialized$) {
        ...
        webWorkerCtx.$postMessage$([2 /* MainInterfacesRequestFromWorker */]);
    }
    else if (msgType === 3 /* MainInterfacesResponseToWorker */) {
        ...
        webWorkerCtx.$postMessage$([4 /* InitializedWebWorker */]);
...
postMessage([0 /* MainDataRequestFromWorker */]);
