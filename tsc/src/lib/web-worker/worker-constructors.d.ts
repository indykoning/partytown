...
export declare const getOrCreateNodeInstance: (winId: WinId, instanceId: InstanceId, nodeName?: string, namespace?: string, instance?: WorkerNode, prevInstanceId?: string) => WorkerNode | undefined;
