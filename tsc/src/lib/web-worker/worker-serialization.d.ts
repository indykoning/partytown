...
export declare const serializeForMain: ($winId$: WinId, $instanceId$: InstanceId, value: any, added?: Set<any>, type?: string) => SerializedTransfer | undefined;
export declare const serializeInstanceForMain: (instance: any, value: any) => SerializedTransfer | undefined;
export declare const deserializeFromMain: (winId: WinId | undefined | null, instanceId: InstanceId | undefined | null, applyPath: ApplyPath, serializedValueTransfer?: SerializedTransfer, serializedType?: SerializedType, serializedValue?: any, obj?: any, key?: string) => any;
