...
export const onMessageFromWebWorker = (worker, msg, winCtx) => {
    if (msg[0] === 4 /* WorkerMessageType.InitializedWebWorker */) {
        ...
        if (winCtx) {
            if (msg[0] === 7 /* WorkerMessageType.InitializeNextScript */) {
                // web worker has been initialized with the main data
                requestAnimationFrame(() => readNextScript(worker, winCtx));
            }
            else if (msg[0] === 6 /* WorkerMessageType.InitializedEnvironmentScript */) {
