...
export declare const serializeForWorker: ($winId$: WinId, value: any, added?: Set<any> | undefined, type?: string | undefined, cstrName?: string | undefined) => SerializedTransfer | undefined;
