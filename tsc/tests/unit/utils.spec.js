...
test('createElementFromConstructor, SVG', ({ doc }) => {
    ...
    assert.is(createElementFromConstructor(doc, 'SVGFEGaussianBlurElement').tagName, 'feGaussianBlur');
    ...
    assert.is(createElementFromConstructor(doc, 'SVGLinearGradientElement').tagName, 'linearGradient');
...
test('createElementFromConstructor, HTML', ({ doc }) => {
    ...
    assert.is(createElementFromConstructor(doc, 'HTMLDivElement').namespaceURI, 'http://www.w3.org/1999/xhtml');
