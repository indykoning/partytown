...
(window => {
    ...
    const FallbackError = window.top.Error;
    const serializedValueIsError = value => {
        var _a;
        return value instanceof ((null === (_a = window.top) || void 0 === _a ? void 0 : _a.Error) || FallbackError);
    };
    ...
    (async receiveMessage => {
        ...
        if (onMessageHandler) {
            worker = new Worker(libPath + "partytown-ww-atomics.js?v=0.10.1", {
                name: "Partytown 🎉"
            });
            worker.onmessage = ev => {
                const msg = ev.data;
            ...
            logMain("Created Partytown web worker (0.10.1)");
