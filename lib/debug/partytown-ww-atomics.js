        ...
        constructor(win) {
            ...
            this.api = {
                ...
                setReceiver: r => {
                    ...
                    receiverFn = r;
                    callMethod(win, [ "__partytown_gtm_debug", "activate" ], [], 1);
                },
                sendMessage: (...args) => {
                    gtmDebugLog("send message", args);
                    return callMethod(win, [ "__partytown_gtm_debug", "sendMessage" ], args, 1);
                },
                disconnect: (...args) => {
                    gtmDebugLog("disconnect", args);
                    return callMethod(win, [ "__partytown_gtm_debug", "disconnect" ], args, 1);
                }
            };
        }
        getApi() {
